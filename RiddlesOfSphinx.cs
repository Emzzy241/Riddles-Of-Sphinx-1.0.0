...
class RiddlesOfSphinx
{
    ...
    static void Main()
    {
        ...
        // TO WRITE MY METHID, I NEED TO MAKE A GREAT CHANGE TO MY ENTIRE CODE, I NEED TO BE ABLE TO STORE ALL OF THE 
        // RIDDLES SOMEWHERE AND BE ABLE TO RANDOMIZE IT
                                                                        ...
                                                                        if (ninthContinueGame == "Y")
                                                                        {
                                                                            ...
                                                                            if (ninthAnswer == "A")
                                                                            {
                                                                                ...
                                                                                if (tenthContinueGame == "Y")
                                                                                {
                                                                                    ...
                                                                                    Console.WriteLine("Times Defeated Sphinx = 9");
